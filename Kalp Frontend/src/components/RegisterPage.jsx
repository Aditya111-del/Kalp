      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-2 text-lg">Create your account</p>
          </div>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                name="agree"
                type="checkbox"
                className="mt-2 h-4 w-4 text-[#5a1fcf] bg-transparent border border-[#3a3a3a] rounded focus:ring-[#5a1fcf] focus:ring-2"
                disabled={loading}
                required
              />
